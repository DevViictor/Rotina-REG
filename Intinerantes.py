...
def tarefas_lazaro():
    ...
    st.set_page_config(page_title="R.E.G LÁZARO", page_icon="🔒",layout="wide")
...
def tarefas_lee():
    ...
    st.set_page_config(page_title="R.E.G LEE", page_icon="🔒",layout="wide")
...
def tarefas_marcus():
    ...
    st.set_page_config(page_title="R.E.G MARCUS", page_icon="🔒",layout="wide")
