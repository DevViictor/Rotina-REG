...
def tarefas_ana():
    ...
    st.set_page_config(page_title="R.E.G ANA MERCIA", page_icon="🔒",layout="wide")
...
def tarefas_francisca():
    ...
    st.set_page_config(page_title="R.E.G FRANCISCA", page_icon="🔒",layout="wide")
...
def tarefas_vinicius():
    ...
    st.set_page_config(page_title="R.E.G VINICIUS", page_icon="🔒",layout="wide")
...
def tarefas_vitor():
    ...
    st.set_page_config(page_title="R.E.G VITOR", page_icon="🔒",layout="wide")
...
def tarefas_vanessa():
    ...
    st.set_page_config(page_title="R.E.G Vanessa", page_icon="🔒",layout="wide")
