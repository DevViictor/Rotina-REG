...
st.set_page_config(page_title="Gerador de Tarefas",
                   layout="wide",
                   page_icon="📝")

# --- LISTAS ---
go = ["","Max","Denise","Diego","Andressa","Vanderlei","Jairo"]
...
def notificacao():
    ...
    requests.post("https://api.pushover.net/1/messages.json", data={
        "token": api_token,
        "user": user_key,
        "message": "Novas tarefas foram criadas. Visualize o painel de tarefas"
    })
...
with st.form("Forms"):
    ...
    nome = st.selectbox("Nome do GL :  ", go)
